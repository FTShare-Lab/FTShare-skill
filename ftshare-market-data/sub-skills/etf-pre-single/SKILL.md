...
|------|------|
| 接口名称 | 查询单只 ETF 盘前数据 |
| 外部接口 | `GET /api/v2/market/data/etf-pre-single` |
| 请求方式 | GET |
...
```
GET /api/v2/market/data/etf-pre-single?symbol=510300.XSHG
```

指定日期：

```
GET /api/v2/market/data/etf-pre-single?symbol=510300.XSHG&date=20260316
```
