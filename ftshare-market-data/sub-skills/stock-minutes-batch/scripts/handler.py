...
def main():
 p=argparse.ArgumentParser(); p.add_argument("--symbols",required=True); p.add_argument("--since-ts-millis",required=True,type=int); p.add_argument("--until-ts-millis",required=True,type=int); p.add_argument("--interval-value",type=int,default=1); p.add_argument("--adjust-kind",type=str.lower,choices=["none","forward","backward"],default="none"); p.add_argument("--limit",type=int,default=50); a=p.parse_args()
